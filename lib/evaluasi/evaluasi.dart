                                                  ...
                                                  child: RichText(
                                                      ...
                                                      text: TextSpan(
                                                          children: <TextSpan>[
                                                            TextSpan(
                                                                text:
                                                                    "Raden Noer Rahmad dalam dakwahnya diperkirakan satu zaman dan satu wilayah dengan Tokoh Walisongo yang bernama Sunan......",
                                                                style: TextStyle(
                                                                    color: Colors
                                                                        .black)),
                                                            // TextSpan(
                                                      ...
                                                      child: RichText(
                                                          ...
                                                          text: TextSpan(
                                                              children: <
                                                                ...
                                                                TextSpan(
                                                                    text:
                                                                        "Masjid Sunan Sendang Duwur juga disebut masyarakat sekitar dengan nama Masjid Tiban, hal tersebut di dasarkan oleh peristiwa..... yang menjadikan masyarakat desa meyakini bahwa itu adalah ",
                                                                    style: TextStyle(
                                                                        color: Colors
                                                                            .black)),
                                                                TextSpan(
                                                              ...
                                                              child: RichText(
                                                                  ...
                                                                  text: TextSpan(
                                                                      children: <
                                                                        ...
                                                                        TextSpan(
                                                                          text:
                                                                              "Tujuan utama secara fungsi dibangunnya Sumur Giling di bagian timur Masjid Sunan Sendang Duwur sebagai, Kecuali....",
                                                                          style:
                                                                              TextStyle(color: Colors.black),
                                                                        )
                                                                      ])),
                                                              ...
                                                              child: RichText(
                                                                  ...
                                                                  text: TextSpan(
                                                                      children: <
                                                                        ...
                                                                        TextSpan(
                                                                            text:
                                                                                "Salah satu penyebab dipilihnya Bukit Amitunon oleh Sunan Drajat sebagai letak Masjid Sunan Sendang ialah..... ",
                                                                            style:
                                                                                TextStyle(color: Colors.black)),
                                                                        // TextSpan(
                                                                        //   text: "“ANSORY MAPS” (Android studio history maps)",
                                                                ...
                                                                Container(
                                                                  ...
                                                                  child: RichText(
                                                                      ...
                                                                      text: TextSpan(children: <TextSpan>[
                                                                        TextSpan(
                                                                            text:
                                                                                "Latar belakang Sunan Sendang Duwur dalam dakwahnya menggunakan prinsip ",
                                                                            style:
                                                                                TextStyle(color: Colors.black)),
                                                                        TextSpan(
                                                                          text:
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Container(
                                                                      ...
                                                                      child: RichText(
                                                                          ...
                                                                          text: TextSpan(children: <TextSpan>[
                                                                            TextSpan(
                                                                                text: "Raden Noer Rahmad Lahir di Sedayu Lawas pada tahun...... dan wafat di Sendang Duwur pada tahun......",
                                                                                style: TextStyle(color: Colors.black)),
                                                                            // TextSpan(
              ...
              children: [
                InkWell(
                  onTap: () {
                    if (soal == 1) {
                      Fluttertoast.showToast(
                          msg: "kamu telah berada di soal yang pertama !",
                          backgroundColor: Colors.black,
                          textColor: Colors.white);
                    } else {
                      setState(() {
                ...
                InkWell(
                  onTap: () {
                    if (soal == 20) {
                      Fluttertoast.showToast(
                          msg: "kamu telah berada di soal yang terakhir !",
                          backgroundColor: Colors.black,
                          textColor: Colors.white);
                    } else {
                      setState(() {
